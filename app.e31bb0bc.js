...
var filterEmployees = function filterEmployees(employees, nameValue) {
  return employees.filter(function (employee) {
    return (employee.name || '').toLowerCase().includes((nameValue || '').toLowerCase());
  });
};

var _default = {
  view: function view(vnode) {
    vnode.state.filteredEmployees = (vnode.state.nameValue ? vnode.state.filteredEmployees : vnode.attrs.employees) || vnode.attrs.employees || [];
    return (0, _mithril.default)("div", {
      "class": "container v-employees"
    }, (0, _mithril.default)("div", {
      "class": "row v-logo--wrapper"
    }, (0, _mithril.default)("div", {
      "class": "column"
    }, (0, _mithril.default)('span', {
      class: 'v-logo--img'
    }, [_mithril.default.trust(_logo.default)]), (0, _mithril.default)("span", {
      "class": "v-logo--text"
    }, "Vivify Ideas"))), (0, _mithril.default)("table", null, (0, _mithril.default)("thead", null, (0, _mithril.default)("tr", null, (0, _mithril.default)("th", null, "Name"), (0, _mithril.default)("th", {
      "class": "float-right"
    }, "Remaining Days Off")), (0, _mithril.default)("tr", null, (0, _mithril.default)("th", null, (0, _mithril.default)('input', {
      type: 'text',
      oninput: _mithril.default.withAttr('value', function (v) {
        vnode.state.nameValue = v;
        vnode.state.filteredEmployees = filterEmployees(vnode.attrs.employees, vnode.state.nameValue);
      })
    })), (0, _mithril.default)("th", null))), (0, _mithril.default)("tbody", null, (vnode.state.filteredEmployees || []).map(function (employee) {
      return (0, _mithril.default)("tr", null, (0, _mithril.default)("td", {
        "class": "v-text--uppercase"
      }, (0, _mithril.default)("a[href=\"/".concat(employee.name, "\"]"), {
        oncreate: _mithril.default.route.link
      }, employee.name)), (0, _mithril.default)("td", {
        "class": "float-right"
      }, employee.days_off_remaining));
    }))));
  }
};
exports.default = _default;
},{"mithril":"../node_modules/mithril/mithril.js","./../../assets/logo.svg":"assets/logo.svg"}],"components/pages/single-employee.component.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  view: function view(vnode) {
    var employee = vnode.attrs.employee || {};
    return (0, _mithril.default)("div", {
      "class": "container"
    }, (0, _mithril.default)("div", {
      "class": "row v-logo--wrapper"
      ...
      "class": "v-logo--text"
    }, "Vivify Ideas"))), (0, _mithril.default)("div", {
      "class": "row"
    }, (0, _mithril.default)("div", {
      "class": "column"
    }, (0, _mithril.default)("h3", {
      "class": "v-text--uppercase"
    }, employee.name, " (", employee.days_off_remaining, ")")), (0, _mithril.default)("div", {
      "class": "column"
    }, (0, _mithril.default)("h4", null, (0, _mithril.default)("a[href=\"/\"]", {
      oncreate: _mithril.default.route.link
    }, '< Back')))), (0, _mithril.default)("div", {
      "class": "row"
    }, (0, _mithril.default)("div", {
      "class": "column"
    }, (0, _mithril.default)("ul", null, (employee.dates || []).map(function (date) {
      return (0, _mithril.default)("li", null, date);
    })))));
  }
};
exports.default = _default;
},{"mithril":"../node_modules/mithril/mithril.js","./../../assets/logo.svg":"assets/logo.svg"}],"../node_modules/animejs/anime.min.js":[function(require,module,exports) {
var global = arguments[3];
var define;
/*
 2017 Julian Garnier
...
},{}],"components/shared/loading.component.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  oncreate: function oncreate(vnode) {
    vnode.dom.innerHTML = _logo.default;
    var svgElement = vnode.dom.querySelector('svg');
  ...
  view: function view() {
    return (0, _mithril.default)("div", {
      "class": "v-logo--loader-wrapper"
    });
  }
};
exports.default = _default;
},{"mithril":"../node_modules/mithril/mithril.js","animejs":"../node_modules/animejs/anime.min.js","./../../assets/logo.svg":"assets/logo.svg"}],"components/pages/login.component.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  view: function view(vnode) {
    return (0, _mithril.default)("div", {
      ...
      "class": "column column-50 column-offset-25 v-text--center"
    }, (0, _mithril.default)('span', {
      class: 'v-logo--img'
    }, [_mithril.default.trust(_logo.default)]))), (0, _mithril.default)("div", {
      "class": "row"
    }, (0, _mithril.default)("div", {
...
exports.default = _default;
},{"mithril":"../node_modules/mithril/mithril.js","./../../assets/logo.svg":"assets/logo.svg"}],"../node_modules/axios/lib/helpers/bind.js":[function(require,module,exports) {
'use strict';
...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"services/employees.service.js":[function(require,module,exports) {
"use strict";
...
Object.assign(_axios.default.defaults.headers.common, {
  accept: 'application/json'
});
_axios.default.defaults.baseURL = 'http://188.166.116.56:3000';
var _default = {
  getEmployees: function getEmployees(params) {
    return _axios.default.get('/employees', params).then(function (_ref) {
      var data = _ref.data;
      return data;
    });
  },
  getSingleEmployee: function getSingleEmployee(id, params) {
    return _axios.default.get("/employees/".concat(id), params).then(function (_ref2) {
      var data = _ref2.data;
      return data[0] || {};
    });
  }
...
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"styles/app.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"./../../node_modules/milligram/dist/milligram.css":"../node_modules/milligram/dist/milligram.css","_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"index.js":[function(require,module,exports) {
"use strict";

var _mithril = _interopRequireDefault(require("mithril"));

var _employees = _interopRequireDefault(require("./components/pages/employees.component"));

var _singleEmployee = _interopRequireDefault(require("./components/pages/single-employee.component"));

var _loading = _interopRequireDefault(require("./components/shared/loading.component"));

var _login = _interopRequireDefault(require("./components/pages/login.component"));

var _employees2 = _interopRequireDefault(require("./services/employees.service"));
...
_mithril.default.route(document.getElementById('app'), '/', {
  '/login': {
    render: function render() {
      return (0, _mithril.default)(_login.default, {
  ...
  '/': {
    ...
    render: function render() {
      if (state.employees.length) {
        return (0, _mithril.default)(_employees.default, {
          employees: state.employees
        });
      }

      _employees2.default.getEmployees({
        auth: state.auth
  ...
  '/:name': {
    onmatch: function onmatch(args) {
      return _employees2.default.getSingleEmployee(args.name, {
        auth: state.auth
    ...
    render: function render(vnode) {
      return (0, _mithril.default)(_singleEmployee.default, {
        employee: state.singleEmployee
      });
    }
  }
});
},{"mithril":"../node_modules/mithril/mithril.js","./components/pages/employees.component":"components/pages/employees.component.js","./components/pages/single-employee.component":"components/pages/single-employee.component.js","./components/shared/loading.component":"components/shared/loading.component.js","./components/pages/login.component":"components/pages/login.component.js","./services/employees.service":"services/employees.service.js","./styles/app":"styles/app.scss"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
